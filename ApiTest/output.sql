...
CREATE INDEX [IX_OfficeAssignment_InstructorID] ON [OfficeAssignment] ([InstructorID]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20201211091030_init', N'5.0.1');
GO
...
ALTER TABLE [Course] ADD [DateModified] datetime2 NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20201211162326_Course_DateModified', N'5.0.1');
GO
